...
void processFCFS(){
    ...
    while(1){
        ...
        if(!isProcess && minPos == -1){
            ...
            /*
            printf("minPos : %i, minP : %i", minPos , minAT);
            char c;
            scanf("%s",&c);*/
            currentEnding = minAT;
            isIdle = 1;
...
void processFCFS_IOBurst(){
   ...
   while(1){
    ...
    float aTAT = 0;
    SetColor("Yellow");
    printf("\n\n %c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c",-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2,-2);
    SetColor("Light Red");
